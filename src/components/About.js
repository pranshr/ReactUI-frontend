          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6 mt-30">
                ...
                <p>Unlisted Tech Private Limited is offering a tech based platform which is empowering various stakeholders of unlisted companies (including Startups, Delisted companies and Pre IPO companies) to Buy/Sell shares in a transparent and safe escrow environment.</p>
                <p>We, through our automated platform, help retail and institutional investors  to transact in equity shares or ESOP of various unlisted companies through a time efficient and secured process and enabling pricediscovery as well. We offer an end to end automated process for transfer of shares or ESOP In safe and secured manner through an escrow mechanism provided through our Banking partner and by way of transaction approved by SEBI registered Trustee.</p>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="found">
                        ...
                        <p>Shubham is a UX designer and an entrepreneur. He started his career as a car designer for various german car manufacturers. He is a lead designer for various startups like coltello store, Greenportfolio, Unlisted Assets, and also for Chatbot automation company LivePerson. He has completed his Masters in Automotive Design from Turin, Italy and he is currently working as a lead designer in Frankfurt, Germany.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-9">
                      <div className="found">
                        ...
                        <p>A seasoned technology professional with 14 years of experience in architecting and managing development and delivery of enterprise level e-commerce applications, Revenue Management Systems and Supply Chain Management systems for fortune 500 customers</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-md-10">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    ...
                    <p>Reach out to explore the endless opportunities in this interesting and growing space. <a href="mailto:hello@unlistedassets.com" className="text-bold">hello@unlistedassets.com</a></p>
                  </div>
                </div>
              </div>
            </div>
